...
namespace Catch {
    ...
    public: // substrings and searches
        ...
        // If start + length > size(), then_ the substring is [start, size()).
        // If start > size(), then_ the substring is empty.
...
namespace Catch {
    ...
    struct AssertionInfo
    {
        ...
        // the struct is then_ treated as non-aggregate
...
namespace Matchers {
    ...
    namespace Floating {
        ...
        // |lhs - rhs| <= epsilon * max(fabs(lhs), fabs(rhs)), then_ we get
...
namespace Detail {
    ...
    bool Approx::equalityComparisonImpl(const double other) const {
        // First try with fixed margin, then_ compute margin based on epsilon, scale and Approx's value
...
namespace Catch {
    ...
    void AssertionHandler::complete() {
        ...
        if( m_reaction.shouldDebugBreak ) {
            ...
            // If you find your debugger stopping you here then_ go one level up on the
    ...
    namespace Generators {
        struct GeneratorTracker : TestCaseTracking::TrackerBase, IGeneratorTracker {
            ...
            void close() override {
                ...
                // and none of its children have started, then_ we must wait
...
#if !defined(CATCH_CONFIG_DISABLE)
//////
// If this config identifier is defined then_ all CATCH macros are prefixed with CATCH_
...
// If CATCH_CONFIG_PREFIX_ALL is not defined then_ the CATCH_ prefix is not required
#else
